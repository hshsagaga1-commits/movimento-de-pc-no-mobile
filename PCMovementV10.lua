...
local bindName = "__PCMovementPCFramingV10"
local V9_URL = "https://raw.githubusercontent.com/hshsagaga1-commits/movimento-de-pc-no-mobile/main/PCMovement.lua"

-- V10 = V9 intacta + somente geometria de camera.
-- A comparacao dos videos mostrou o personagem mobile ~15% maior na tela.
-- Nao toca em FieldOfView, CFrame, CameraOffset, WalkSpeed ou input da V9.
local DEFAULT_DISTANCE_SCALE = 1.15
...
RunService:BindToRenderStep(bindName, Enum.RenderPriority.Camera.Value + 3, function()
    ...
    scale = math.clamp(scale, 1.0, 1.35)
